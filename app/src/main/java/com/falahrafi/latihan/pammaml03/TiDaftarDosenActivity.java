...
public class TiDaftarDosenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ti_daftar_dosen);
        ...
        list.addAll(DosensData.getListData("Teknik Informatika"));
        showRecyclerList();
    }
